...
class StoryBrain {
  ...
  void nextStory({int choiceNumber = 0}) {
    if (choiceNumber == 2 && _storyNo == 0) {
      _storyNo = 1;
    } else {
      if (choiceNumber == 1 && _storyNo == 0) {
        _storyNo = 2;
      } else {
        if (_storyNo == 1 && choiceNumber == 1) {
          _storyNo = 2;
        } else {
          if (_storyNo == 1 && choiceNumber == 2) {
            _storyNo = 3;
          } else {
            if (_storyNo == 2 && choiceNumber == 1) {
              _storyNo = 5;
            } else {
              if (_storyNo == 2 && choiceNumber == 2) {
                _storyNo = 4;
              } else {
